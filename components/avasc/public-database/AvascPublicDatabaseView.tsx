  ...
  return (
    <div className="space-y-4">
      <section className="rounded-2xl border border-white/[0.08] bg-[linear-gradient(145deg,var(--avasc-bg-soft)_0%,var(--avasc-blue)_100%)] p-6 shadow-[0_20px_50px_-28px_rgba(0,0,0,0.5)]">
        ...
        <h3 className="font-display mt-4 text-xl font-medium text-white">{t("realtimeAlertsTitle")}</h3>
        <p className="mt-3 text-sm leading-7 text-[var(--avasc-text-secondary)]">{t("realtimeAlertsDesc")}</p>
        <Link
      ...
      <section className="rounded-2xl border border-white/[0.07] bg-[var(--avasc-bg-card)]/85 p-6 shadow-[0_16px_40px_-24px_rgba(0,0,0,0.45)] backdrop-blur-sm">
        <h3 className="font-display text-lg font-medium text-white">{t("searchTips")}</h3>
      ...
      <section className="rounded-2xl border border-white/[0.07] bg-[var(--avasc-bg-card)]/85 p-6 shadow-[0_16px_40px_-24px_rgba(0,0,0,0.45)] backdrop-blur-sm">
        ...
        <p className="mt-3 text-sm leading-7 text-[var(--avasc-text-secondary)]">{t("publicSafetyDesc")}</p>
      </section>
    </div>
  );
}
...
function DatabaseEmptyState() {
  ...
  return (
    <section className="rounded-2xl border border-white/[0.07] bg-[var(--avasc-bg-card)]/85 p-10 text-center shadow-[0_16px_40px_-24px_rgba(0,0,0,0.45)] backdrop-blur-sm">
      ...
      <h3 className="font-display mt-5 text-xl font-medium text-white">{t("emptyTitle")}</h3>
      <p className="mx-auto mt-3 max-w-xl text-sm leading-7 text-[var(--avasc-text-secondary)]">{t("emptyBody")}</p>
    </section>
  );
}
